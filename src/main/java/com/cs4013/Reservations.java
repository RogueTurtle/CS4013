...
public class Reservations implements HubInterface {
     ...
     */
    public Reservations (HubInterface mainHub) {
     ...
     */
    private LocalDateTime promptDate (String prompt) {
